...
async function sendMicrosoft(id, session) {
  try {
    const response = await fetch(
      `https://www.fibofy.com/msteams-fibo/startNewConversation/${id}/channel_id/${session}?shared_channel=teams-bot&team_id=teams_abc&session_type=Nano`,
      {
        headers: {
          accept: "*/*",
          authorization:
...
async function sendBrainly(id, session, team_id) {
  try {
    const res2 = await fetch(
      `https://www.fibofy.com/panda-sharedchannels/checkUserPrivateChannel/${id}?shared_channel=brainly&team_id=${team_id}&session_type=Nano&bypass=cc4d9d62ad12bb29cce8663cffdaf6e9026961cc81b8dfcf10d4683087403180`,
      {
        headers: {
          accept: "*/*",
          "accept-language": "ru-RU,ru;q=0.9,en-US;q=0.8,en;q=0.7,uk;q=0.6",
...
async function sendCulturedBrain(id, session, team_id) {
  try {
    const res2 = await fetch(
      `https://www.fibofy.com/panda-sharedchannels/checkUserPrivateChannel/${id}?shared_channel=culturedbrain&team_id=${team_id}&session_type=Nano&bypass=cc4d9d62ad12bb29cce8663cffdaf6e9026961cc81b8dfcf10d4683087403180`,
      {
        headers: {
          accept: "*/*",
          "accept-language": "ru-RU,ru;q=0.9,en-US;q=0.8,en;q=0.7,uk;q=0.6",
    ...
    const channel_id = result1.data.body.channel.id;
    var response = await fetch(
      `https://www.fibofy.com/panda-sharedchannels/startNewConversation/${id}/${channel_id}/${session}?shared_channel=culturedbrain&team_id=${team_id}&session_type=Nano`,
      {
        headers: {
          accept: "*/*",
          authorization:
...
async function sendPandatron(id, session) {
  try {
    const res2 = await fetch(
      `https://www.fibofy.com/panda-sharedchannels/checkUserPrivateChannel/${id}?shared_channel=pandacoachbot&team_id=T014DKXB53N&session_type=Nano&bypass=cc4d9d62ad12bb29cce8663cffdaf6e9026961cc81b8dfcf10d4683087403180`,
      {
        headers: {
          accept: "*/*",
          "accept-language": "ru-RU,ru;q=0.9,en-US;q=0.8,en;q=0.7,uk;q=0.6",
    ...
    const channel_id = result1.data.body.channel.id;
    var response = await fetch(
      `https://www.fibofy.com/panda-sharedchannels/startNewConversation/${id}/${channel_id}/${session}?shared_channel=pandacoachbot&team_id=T014DKXB53N&session_type=Nano`,
      {
        headers: {
          accept: "*/*",
          authorization:
...
async function getMonday() {
  try {
    var response = await fetch(
      "https://61vqrvqwn3.execute-api.us-east-1.amazonaws.com/staging2?day=Monday",
      {
        method: "GET",
        headers: {
...
async function getTuesday() {
  try {
    var response = await fetch(
      "https://61vqrvqwn3.execute-api.us-east-1.amazonaws.com/staging2?day=Tuesday",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
async function getWednesday() {
  try {
    var response = await fetch(
      "https://61vqrvqwn3.execute-api.us-east-1.amazonaws.com/staging2?day=Wednesday",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
const getThursday = async () => {
  try {
    var response = await fetch(
      "https://61vqrvqwn3.execute-api.us-east-1.amazonaws.com/staging2?day=Thursday",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
async function getFriday() {
  try {
    var response = await fetch(
      "https://61vqrvqwn3.execute-api.us-east-1.amazonaws.com/staging2?day=Friday",
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
...
setInterval(() => {
  ...
  for (let index = 0; index < Data.length; index++) {
    ...
    if (
      element.morninghours === date.getHours() &&
      element.morningminutes === date.getMinutes()
    ) {
    ...
    if (
      element.eveninghours === date.getHours() &&
      element.eveningminutes === date.getMinutes()
    ) {
      console.log("found the user");
